...
function Register() {
  ...
  return (
    <div className=" bg-[#95ccd1] w-screen h-screen overflow-hidden  bg-cover bg-center  ">
        ...
        <button className='w-32 bg-black rounded-md hover:bg-gray-600 '><div className='text-white font-semibold text-lg'><Link to="/login" className="text-decoration-none text-white">Login</Link></div></button>
        </div>
       <div className=' flex justify-center w-screen h-screen items-center '>
        <div className='bg-white border border-gray-200  pb-4 rounded-xl mb-16 shadow-lg w-[700px] mx-[600px] px-[45px]'>
        <form  onSubmit={handleSubmit}>
            ...
            <div className='text-md text-gray-600 font-semibold'><label htmlFor="">Name</label></div>
                <div className='w-96'>
                <input type="text"  placeholder='Enter name'  onChange={e=>setValues({...values,name:e.target.value})}
            ...
            <div className='flex justify-end mt-8 mb-4'>
                <button className='w-32 bg-slate-600 p-1 rounded-md hover:bg-slate-800'><div className='text-white font-semibold text-md'>Register</div></button>
            </div>
        </form>
        </div>
       </div>
